...
public interface TrainSeatMapper {
    ...
    int cancelSeat(@Param("trainNumberId") int trainNumberId, @Param("ticket") String ticket, @Param("carriageNum") Integer carriageNum,
                   @Param("rowNum") Integer rowNum, @Param("seatNum") Integer seatNum,@Param("travellerId") long travellerId, @Param("userId") long userId);
}